...
public aspect cmd {
	...
	after(String[] args) : execution(void Main.Main.main(String[]))&&args(args){
	...
	private void runCommand(String command) {
		...
		case "addPlayer":
			...
			break;
		case "addCarer":
			commandAddCarer(commandSplitted[1]);
			break;
		case "teams":
			commandTeams();
			break;
	...
	private void commandAddCarer(String input) {
		System.out.println("Adding Carer...");
	}
