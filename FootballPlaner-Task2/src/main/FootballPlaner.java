...
public class FootballPlaner {
	...
	public static void main(String[] args) {
		cmd = properties.PropertyManager.getProperty("cmd");
		result = properties.PropertyManager.getProperty("result");
		calendar = properties.PropertyManager.getProperty("calendar");
		checkArgs(args);
		gp = new planer.Gameplaner(result);
		testGames();
		/*
		...
		if (cmd) {
			appearance.cmd console = new appearance.cmd(result, calendar, gp);
			console.runCMD();
		}
	}
